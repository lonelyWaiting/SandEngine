...
{
	HWND hwnd              = nullptr;
	SVector2f pos          = SVector2f(0.0f, 0.0f);
	SVector2f offset       = SVector2f(0.0f, 0.0f);
	eMouseButton mouseType = eMB_None;
};
...
enum eKeyCode
{
	...
	OemSemicolon       = 0xba, // Used for miscellaneous characters; it can vary by keyboard.      the US standard keyboard, the ';:' key
	Oem1               = 0xba, // Used for miscellaneous characters; it can vary by keyboard.      the US standard keyboard, the ';:' key
	...
	OemQuestion        = 0xbf, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '/?' key
	Oem2               = 0xbf, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '/?' key
	OemTilde           = 0xc0, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '`~' key
	Oem3               = 0xc0, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '`~' key
	// 0xC1 - D7 are reserved
	// 0xD8 - DA are unassigned
	OemOpenBrackets    = 0xdb, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '[{' key
	Oem4               = 0xdb, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '[{' key
	OemPipe            = 0xdc, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '\|' key
	Oem5               = 0xdc, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the '\|' key
	OemCloseBrackets   = 0xdd, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the ']}' key
	Oem6               = 0xdd, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the ']}' key
	OemQuotes          = 0xde, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the 'single-quote/double-quote' key
	Oem7               = 0xde, // Used for miscellaneous characters; it can vary by keyboard. F    US standard keyboard, the 'single-quote/double-quote' key
	Oem8               = 0xdf, // Used for miscellaneous characters; it can vary by keyboard.
	// 0xE0 is reserved
	// 0xE1 is OEM specific
	OemBackslash       = 0xe2, // Either the angle bracket key or the backslash key on the RT 1    keyboard
	Oem102             = 0xe2, // Either the angle bracket key or the backslash key on the RT 1    keyboard
	// 0xE3 - E4 OEM specific
	ProcessKey         = 0xe5, // IME Process key
	// 0xE6 is OEM specific
	Packet             = 0xe7, // Used to pass Unicode characters as if they were keystrokes. T    Packet key value is the low word of a 32-bit virtual-key value used for non-keyboard i    methods.
	// 0xE8 is unassigned
...
struct sKeyEventInfo
{
	eKeyCode keyCode = None;
	unsigned int key = 0;
	bool shift       = false;
	bool control     = false;
	bool alt         = false;
